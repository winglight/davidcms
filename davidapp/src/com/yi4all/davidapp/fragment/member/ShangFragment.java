...
public class ShangFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(R.layout.fragment_member_shang, container, false);

		list = (PullToRefreshListView) v.findViewById(R.id.shang_hall_list);
			...
			((BaseActivity)getActivity()).getService().getMemberHalls(
				...
				public void handleMessage(Message msg) {
					...
					if (msg.arg1 == 0) {
						...
						List<Hall> remoteMoreIssues = (List<Hall>) msg.obj;
	...
	private class AppAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView, ViewGroup vg) {
			...
			// other normal row
			final Hall am = persons.get(position);
